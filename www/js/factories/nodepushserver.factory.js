(function(){
	...
	/**
	* Factory for node-pushserver (running locally in this case), 
	*if you are using other push notifications server you need to change this
	*/
	var NodePushServer=function($http){
  ...
  return {
	...
	*/
	...
	NodePushServer.$inject=['$http'];

	angular
		.module('tatafo')
		.factory('NodePushServer',NodePushServer)
